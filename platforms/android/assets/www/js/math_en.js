...
document.getElementById("name").addEventListener("change", function () {
	...
	document.getElementById('gran1').innerHTML="Limitation  [-50 100]";
	document.getElementById('gran2').innerHTML="Limitation  [-50 100]";}
	else{
	document.getElementById('gran1').innerHTML="Limitation  [-60 100]";
	document.getElementById('gran2').innerHTML="Limitation  [-60 100]";
	}
});
